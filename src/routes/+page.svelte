<script lang="ts">
    ...
    const tools = [
        ...
        },
        {
            ...
            description: "Generate LL(1) parsing table and check if your grammar is LL(1)",
            href: "/ll1-table"
        },
        {
...
<svelte:head>
    <title>LFC Playground</title>
</svelte:head>

<div class="flex flex-col items-center justify-center w-full h-full gap-8 text-center">
